...
var _user$project$Model$place = _eeue56$elm_all_dict$EveryDict$insert;
var _user$project$Model$getListOfMatchingEdges = F2(
	function (piece, board) {
		return A2(
			...
			_eeue56$elm_all_dict$EveryDict$toList(board));
	});
var _user$project$Model$initialBoard = _eeue56$elm_all_dict$EveryDict$empty;
var _user$project$Model$getPiece = _eeue56$elm_all_dict$EveryDict$get;
...
var _user$project$Model$nodeIdPossibilities = {
	ctor: '::',
...
var _user$project$Model$getAvailableBoardIds = function (board) {
	var usedIds = _eeue56$elm_all_dict$EveryDict$keys(board);
	return A2(
		_elm_lang$core$List$filter,
		function (boardId) {
			return !A2(_elm_lang$core$List$member, boardId, usedIds);
		},
	...
	function (extraAttributes, _p1) {
		...
		return A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$d(dString),
					_1: {ctor: '[]'}
				}),
			{ctor: '[]'});
	});
var _user$project$View$attributesFromPiece = function (piece) {
	...
	if (_p5.ctor === 'User') {
		return {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$fill('#0074D9'),
			_1: {ctor: '[]'}
		};
	} else {
		return {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$fill('#FF851B'),
			_1: {ctor: '[]'}
		};
	}
};
		...
		_elm_lang$svg$Svg$circle,
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fill('#2ECC40'),
						_1: {ctor: '[]'}
					}
				}
			}
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$View$renderBoard, model.selected, model.board),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
				...
				A2(
					...
					function (_p13) {
						...
						return A2(
							_user$project$Extras$find,
							function (_p15) {
								return !A2(_user$project$Update$losingMove, model, _p15);
							},
							moves);
					},
					A2(
...
var _user$project$Ports$newGame = _elm_lang$core$Native_Platform.incomingPort(
	'newGame',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));

var _user$project$GameOfSim$subscriptions = _elm_lang$core$Basics$always(
	_user$project$Ports$newGame(
		_elm_lang$core$Basics$always(_user$project$Msg$NewGame)));
var _user$project$GameOfSim$init = {ctor: '_Tuple2', _0: _user$project$Model$defaultModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$GameOfSim$main = _elm_lang$html$Html$program(
	{init: _user$project$GameOfSim$init, update: _user$project$Update$update, subscriptions: _user$project$GameOfSim$subscriptions, view: _user$project$View$view})();

var Elm = {};
Elm['GameOfSim'] = Elm['GameOfSim'] || {};
if (typeof _user$project$GameOfSim$main !== 'undefined') {
    _user$project$GameOfSim$main(Elm['GameOfSim'], 'GameOfSim', undefined);
}
