...
var _user$project$Model$place = _robertjlooby$elm_generic_dict$GenericDict$insert;
var _user$project$Model$getListOfMatchingEdges = F2(
	function (piece, board) {
		return A2(
			_elm_lang$core$List$filterMap,
			function (_p0) {
				var _p1 = _p0;
				return _elm_lang$core$Native_Utils.eq(piece, _p1._1) ? _elm_lang$core$Maybe$Just(_p1._0) : _elm_lang$core$Maybe$Nothing;
			},
			_robertjlooby$elm_generic_dict$GenericDict$toList(board));
	});
var _user$project$Model$getPiece = _robertjlooby$elm_generic_dict$GenericDict$get;
var _user$project$Model$Model = F3(
	function (a, b, c) {
		return {board: a, selected: b, gameState: c};
	});
...
var _user$project$Model$nodeIdPossibilities = _elm_lang$core$Native_List.fromArray(
	[_user$project$Model$A, _user$project$Model$B, _user$project$Model$C, _user$project$Model$D, _user$project$Model$E, _user$project$Model$F]);
var _user$project$Model$nodeIdComparer = F2(
	function (nodeId1, nodeId2) {
		return A2(
			_elm_lang$core$Basics$compare,
			A2(_user$project$Extras$indexOfDefault, _user$project$Model$nodeIdPossibilities, nodeId1),
			A2(_user$project$Extras$indexOfDefault, _user$project$Model$nodeIdPossibilities, nodeId2));
	});
var _user$project$Model$boardIdPossibilities = A2(
	...
	function (nodeId1) {
		return A2(
			_elm_lang$core$List$filterMap,
			function (nodeId2) {
				var _p2 = A2(_user$project$Model$nodeIdComparer, nodeId1, nodeId2);
				if (_p2.ctor === 'LT') {
					return _elm_lang$core$Maybe$Just(
						{ctor: '_Tuple2', _0: nodeId1, _1: nodeId2});
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
			},
			_user$project$Model$nodeIdPossibilities);
	},
	_user$project$Model$nodeIdPossibilities);
var _user$project$Model$getAvailableBoardIds = function (board) {
	var usedIds = _robertjlooby$elm_generic_dict$GenericDict$keys(board);
	return A2(
		_elm_lang$core$List$filter,
		function (boardId) {
			return _elm_lang$core$Basics$not(
				A2(_elm_lang$core$List$member, boardId, usedIds));
		},
		_user$project$Model$boardIdPossibilities);
};
var _user$project$Model$boardIdComparer = F2(
	function (_p4, _p3) {
		var _p5 = _p4;
		var _p6 = _p3;
		var _p7 = A2(_user$project$Model$nodeIdComparer, _p5._0, _p6._0);
		if (_p7.ctor === 'EQ') {
			return A2(_user$project$Model$nodeIdComparer, _p5._1, _p6._1);
		} else {
			return _p7;
		}
	});
var _user$project$Model$initialBoard = _robertjlooby$elm_generic_dict$GenericDict$empty(_user$project$Model$boardIdComparer);
var _user$project$Model$defaultModel = {
	board: _user$project$Model$initialBoard,
	selected: _elm_lang$core$Maybe$Just(_user$project$Model$User),
	gameState: _user$project$Model$InProgress
};

var _user$project$MaterialModel$defaultState = {mdl: _debois$elm_mdl$Material$model, model: _user$project$Model$defaultModel};
var _user$project$MaterialModel$MaterialModel = F2(
	function (a, b) {
...
var _user$project$MaterialMsg$U = function (a) {
	return {ctor: 'U', _0: a};
};
var _user$project$MaterialMsg$Mdl = function (a) {
...
var _user$project$View$nodeIdToPosition = function (nodeId) {
	var _p0 = nodeId;
	switch (_p0.ctor) {
		case 'A':
			return {ctor: '_Tuple2', _0: (_user$project$View$boardWidth * 5) / 6, _1: _user$project$View$centerY};
		case 'B':
			return {ctor: '_Tuple2', _0: (_user$project$View$boardWidth * 2) / 3, _1: _user$project$View$boardHeight / 6};
		case 'C':
			return {ctor: '_Tuple2', _0: _user$project$View$boardWidth / 3, _1: _user$project$View$boardHeight / 6};
		case 'D':
			return {ctor: '_Tuple2', _0: _user$project$View$boardWidth / 6, _1: _user$project$View$centerY};
		case 'E':
			return {ctor: '_Tuple2', _0: _user$project$View$boardWidth / 3, _1: (_user$project$View$boardHeight * 5) / 6};
		default:
			return {ctor: '_Tuple2', _0: (_user$project$View$boardWidth * 2) / 3, _1: (_user$project$View$boardHeight * 5) / 6};
	}
};
var _user$project$View$halfEdgeSize = 5;
var _user$project$View$drawEdge = F2(
	function (extraAttributes, _p1) {
		var _p2 = _p1;
		var _p3 = _user$project$View$nodeIdToPosition(_p2._1);
		var x2 = _p3._0;
		var y2 = _p3._1;
		var _p4 = _user$project$View$nodeIdToPosition(_p2._0);
		var x1 = _p4._0;
		var y1 = _p4._1;
		var yOffset = ((_elm_lang$core$Native_Utils.cmp(x1, x2) < 0) || (_elm_lang$core$Native_Utils.cmp(y1, y2) > 0)) ? (0 - _user$project$View$halfEdgeSize) : _user$project$View$halfEdgeSize;
		var dString = A2(
			_elm_lang$core$Basics_ops['++'],
			'M ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(x1 - _user$project$View$halfEdgeSize),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' ',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(y1 - yOffset),
						A2(
							_elm_lang$core$Basics_ops['++'],
							' L ',
							A2(
								...
								A2(
									...
									A2(
										...
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(x2 + _user$project$View$halfEdgeSize),
												A2(
													_elm_lang$core$Basics_ops['++'],
													' ',
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(y2 + yOffset),
														A2(
															_elm_lang$core$Basics_ops['++'],
															' L ',
															A2(
...
var _user$project$View$attributesFromPiece = function (piece) {
	var _p5 = piece;
	if (_p5.ctor === 'User') {
		return _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$fill('#0074D9')
			]);
	} else {
		return _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$fill('#FF851B')
			]);
	}
};
var _user$project$View$renderEdges = F2(
	function (selected, board) {
		return A2(
			_elm_lang$core$List$map,
			function (boardId) {
				var _p6 = A2(_user$project$Model$getPiece, boardId, board);
				if (_p6.ctor === 'Just') {
					return A2(
						_user$project$View$drawEdge,
						_user$project$View$attributesFromPiece(_p6._0),
						boardId);
				} else {
					var _p7 = selected;
					if (_p7.ctor === 'Just') {
...
var _user$project$View$drawNode = function (_p8) {
	var _p9 = _p8;
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$svg$Svg_Attributes$fill('#2ECC40')
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$View$nodes = A2(
	_elm_lang$core$List$map,
	_user$project$View$drawNode,
	A2(_elm_lang$core$List$map, _user$project$View$nodeIdToPosition, _user$project$Model$nodeIdPossibilities));
var _user$project$View$renderBoard = F2(
	function (selected, board) {
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_user$project$View$renderEdges, selected, board),
				_user$project$View$nodes));
	});
...
var _user$project$View$view = function (_p11) {
	var _p12 = _p11;
	var _p13 = _p12.model;
	return A2(
		_elm_lang$html$Html$div,
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$MaterialMsg$U(_user$project$Msg$NewGame))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_user$project$View$gameStateToString(_p13.gameState))
										])),
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											A2(_user$project$View$renderBoard, _p13.selected, _p13.board)
										]))
								]))
						])))
			]));
...
var _user$project$Update$applyMove = F2(
	function (model, _p0) {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				board: A3(_user$project$Model$place, _p1._1, _p1._0, model.board)
			});
	});
...
var _user$project$Update$boardHasTriangleOf = F2(
	function (piece, board) {
		var matchingEdges = A2(_user$project$Model$getListOfMatchingEdges, piece, board);
		return _user$project$Update$isJust(
			A2(
				...
				function (_p3) {
					...
					var _p10 = _p4._1;
					var _p9 = _p4._0;
					var corner2Targets = A2(
						_elm_lang$core$List$filterMap,
						function (_p5) {
							var _p6 = _p5;
							var _p8 = _p6._1;
							var _p7 = _p6._0;
							return _elm_lang$core$Native_Utils.eq(_p7, _p10) ? _elm_lang$core$Maybe$Just(_p8) : (_elm_lang$core$Native_Utils.eq(_p8, _p10) ? _elm_lang$core$Maybe$Just(_p7) : _elm_lang$core$Maybe$Nothing);
						},
						matchingEdges);
					return A2(
						_elm_lang$core$List$any,
						function (corner3) {
							return A2(
								...
								{ctor: '_Tuple2', _0: corner3, _1: _p9},
								matchingEdges) || A2(
								_elm_lang$core$List$member,
								{ctor: '_Tuple2', _0: _p9, _1: corner3},
								matchingEdges);
						},
						corner2Targets);
				},
...
var _user$project$Update$isUserLosingModel = function (model) {
	return A2(_user$project$Update$boardHasTriangleOf, _user$project$Model$User, model.board);
};
...
var _user$project$Update$isCPULosingModel = function (model) {
	return A2(_user$project$Update$boardHasTriangleOf, _user$project$Model$CPU, model.board);
};
var _user$project$Update$losingMove = F2(
	function (model, move) {
		return _user$project$Update$isCPULosingModel(
			A2(_user$project$Update$applyMove, model, move));
	});
var _user$project$Update$getMoves = function (board) {
	return A2(
		...
		A2(
			...
			F2(
				function (v0, v1) {
					return {ctor: '_Tuple2', _0: v0, _1: v1};
				})(_user$project$Model$CPU),
			_user$project$Model$getAvailableBoardIds(board)));
};
var _user$project$Update$cpuTurn = function (model) {
	var moves = _user$project$Update$getMoves(model.board);
				...
				A2(
					...
					function (_p13) {
						...
						return A2(
							...
							function (_p15) {
								return _elm_lang$core$Basics$not(
									A2(_user$project$Update$losingMove, model, _p15));
							},
							moves);
					},
					A2(
						_user$project$Extras$find,
						_user$project$Update$winningMove(model),
						moves)))));
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p16.ctor) {
			case 'NewGame':
				return {ctor: '_Tuple2', _0: _user$project$Model$defaultModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Place':
				...
				if (_p17.ctor === 'Just') {
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{
							board: A3(_user$project$Model$place, _p16._0, _p17._0, model.board)
						});
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selected: _elm_lang$core$Maybe$Just(_p16._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$MaterialUpdate$materialUpdate = F2(
	function (msg, materialModel) {
		var _p0 = msg;
		if (_p0.ctor === 'U') {
			var _p1 = A2(_user$project$Update$update, _p0._0, materialModel.model);
			var model = _p1._0;
			var cmds = _p1._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					materialModel,
					{model: model}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$MaterialMsg$U, cmds)
			};
		} else {
			return A2(_debois$elm_mdl$Material$update, _p0._0, materialModel);
		}
	});

var _user$project$GameOfSim$subscriptions = _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none);
var _user$project$GameOfSim$init = {ctor: '_Tuple2', _0: _user$project$MaterialModel$defaultState, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$GameOfSim$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$GameOfSim$init, update: _user$project$MaterialUpdate$materialUpdate, subscriptions: _user$project$GameOfSim$subscriptions, view: _user$project$View$view})
};

var Elm = {};
Elm['GameOfSim'] = Elm['GameOfSim'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['GameOfSim'], 'GameOfSim', typeof _user$project$GameOfSim$main === 'undefined' ? null : _user$project$GameOfSim$main);
